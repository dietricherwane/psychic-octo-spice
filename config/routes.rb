Rails.application.routes.draw do
  ...
  get '/eppl/api/36e25e6bfd/bet/place/:game_id/:gamer_id/:ticket_id/:transaction_amount/:win_amount/:begin_date/:bet_status' => 'eppl#api_place_bet'
  get '/eppl/api/36e25e6bfd/bet/place/:game_id/:gamer_id/:transaction_amount/:begin_date/:bet_status' => 'eppl#api_place_bet'
  ...
  get '/eppl/api/ok478j41fd/account/reload/:gamer_id/:transaction_amount' => 'eppl#api_recharge_eppl_account'
  ...
  get '/administrator/all_winners' => 'gamers#all_winners', as: :all_winners
