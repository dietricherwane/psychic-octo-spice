	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "<span class='itemsPerPage'>Nombre d'éléments par page:</span> _MENU_",
				"sZeroRecords": "Aucune correspondance trouvée",
				"sEmptyTable": "Aucune donnée disponible",
				"sLoadingRecords": "Chargement...",
				"sInfo": "Affichage de _START_ à _END_ sur _TOTAL_ entries",
				"sInfoEmpty": "Affichage de 0 à 0 sur 0 entries",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" placeholder="critères de recherche..." /><div class="srch"></div>';
