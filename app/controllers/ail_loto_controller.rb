class AilLotoController < ApplicationController
  ...
  def api_acknowledge_bet
    ...
    @error_description = ''
    response_body = ''
    @bet = (AilLoto.where("transaction_id = ?", params[:transaction_id]).first rescue nil)
  ...
  def api_acknowledge_cancel
    ...
    @error_description = ''
    response_body = ''
    @bet = (AilLoto.where("transaction_id = ? AND cancellation_acknowledge IS FALSE", params[:transaction_id]).first rescue nil)
