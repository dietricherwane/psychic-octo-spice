class AilLotoController < ApplicationController
  ...
  def api_validate_transaction
    ...
    if notification_object.blank?
      ...
      @bet = (AilLoto.where(audit_number: (notification_object["AuditId"].to_s rescue ""), ref_number: (notification_object["RefNumber"].to_s rescue ""), ticket_number: (notification_object["TicketNumber"].to_s rescue ""))
      if @bet.blank?
        @error_code = '4000'
